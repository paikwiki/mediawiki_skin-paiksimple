 ...
 * @ingroup Skins
 */
class SkinPaikSimple extends SkinTemplate {
	/** Using paiksimple. */
	var $skinname = 'paiksimple', $stylename = 'paiksimple',
		$template = 'PaikSimpleTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'paiksimple/main.css', 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}

		$out->addStyle( 'paiksimple/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		$out->addStyle( 'paiksimple/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'paiksimple/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'paiksimple/IE70Fixes.css', 'screen', 'IE 7' );

		$out->addStyle( 'paiksimple/rtl.css', 'screen', '', 'rtl' );
 ...
 * @ingroup Skins
 */
class PaikSimpleTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for PaikSimple skin.
...
<!-- <div class="visualClear"></div> chPaik --> 
...
<?php		}
		...
		wfRunHooks( 'PaikSimpleTemplateToolboxEnd', array( &$this ) );
